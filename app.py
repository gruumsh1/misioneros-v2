...
# ============================================
# ZONAS (nombre visible -> nombre en base de datos)
# ============================================
mapeo_a_corto = {
...
zonas_display = list(mapeo_a_corto.keys())
...
# ============================================
# TARJETA 1: SELECCIÓN (botones grandes, sin desplegables)
# ============================================
with st.container(border=True):
    st.markdown("##### 1. Elija su compañerismo")
    zona = st.pills(
        "Compañerismo",
        options=zonas_display,
        default=zonas_display[0],
        key="zona_pill",
    ...
    if mis_txt:
        st.markdown(f'<p class="muted">Misioneros asignados: <strong>{html.escape(mis_txt)}</strong></p>', unsafe_allow_html=True)
...
# Garantizar valores si algo llega vacío
if mes_sel is None:
    mes_sel = hoy.month
if anio_sel is None:
    anio_sel = hoy.year
...
# ============================================
# TARJETA 3: LISTA DEL MES (con teléfonos tocables)
# ============================================
with st.container(border=True):
